...
export default class ScreenshotParser {
    ...
    AREA_NUMBER_HOT_SPOTS = [
        [[8, 5, 0], [4, 11, 0], [8, 17, 0], [11, 11, 0], [8, 11, 255], [7, 12, 255], [8, 9, 255]], // 0
        [[5, 7, 0], [8, 7, 0], [8, 12, 0], [8, 16, 0], [11, 8, 255]], // 1
        [[5, 7, 0], [8, 5, 0], [10, 6, 0], [8, 12, 0], [5, 17, 0], [10, 17, 0]], // 2
        [[5, 7, 0], [8, 5, 0], [11, 8, 0], [8, 11, 0], [11, 13, 0], [8, 17, 0], [5, 15, 0], [5, 9, 255], [5, 13, 255]], // 3
        [[10, 7, 0], [5, 11, 0], [5, 14, 0], [10, 14, 0], [10, 16, 0], [5, 7, 255]], // 4
        [[10, 5, 0], [6, 5, 0], [5, 10, 0], [10, 10, 0], [11, 13, 0], [8, 17, 0], [5, 15, 0], [10, 8, 255], [4, 12, 255]], // 5
    ...
    parse(): BoardDto {
        if (this.image.width > 720) {
            this.image = this.image.resize({width: 720, height: this.image.height / this.image.width * 720})
        }
